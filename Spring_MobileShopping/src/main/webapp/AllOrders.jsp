<%@ page language="java" import="java.util.*" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="com.tek.com.demo.model.finalorder,com.tek.com.demo.model.Items,org.hibernate.Session,org.hibernate.SessionFactory,com.tek.com.demo.service.ServicesOfShop,org.hibernate.cfg.Configuration,org.hibernate.boot.registry.StandardServiceRegistryBuilder"%>
